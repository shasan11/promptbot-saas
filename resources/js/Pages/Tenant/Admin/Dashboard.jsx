        ...
        <AuthenticatedLayout title="Dashboard">
            ...
            <section className="relative mb-4 overflow-hidden rounded-xl bg-navy-900 px-5 py-5 text-white shadow-soft-lg sm:px-6">
                ...
                <div className="relative flex flex-col justify-between gap-5 sm:flex-row sm:items-center">
                    <div><div className="mb-2 flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-brand-300"><span className="h-1.5 w-1.5 animate-pulse rounded-full bg-brand-400" /> Workspace overview</div><h1 className="text-xl font-bold tracking-tight sm:text-2xl">Good to see you, {user?.name?.split(' ')[0] || 'there'}.</h1><p className="mt-1 max-w-xl text-sm text-slate-300">Here’s what needs attention across {tenant.company_name} today.</p></div>
